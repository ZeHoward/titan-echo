...
以使用者提供的二代攻略與 TT2 7.5.0 資料表校正。103 神器、六基礎技能、66 項技能樹資料、37 英雄、30 寵物與裝備主屬性已接入；完整六流派、特殊技能觸發、昇華、突襲、公會與原版基礎曲線仍未完成。

前版自訂地下城、週試煉、英雄死亡、第二世界等規則已停用。舊神器投入返還，Pages 保留修正前完整備份。裝備及寵物的取得分布仍有明確標示的近似規則。

現況以 [規則核對](public/rules.html) 和 [技術核對紀錄](TT2-RULES.md) 為準；舊版 CONTENT-COVERAGE.md 是歷史資料，不代表目前實作。
